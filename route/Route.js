 ...
 * @Last modified time: 2018-01-30T10:25:07+08:00
 */
...
//question
router.get('/api/fetchquestionlist', postCtrl.fetchList);
router.get('/api/fetchquestion', postCtrl.fetch);
router.post('/api/postquestion', postCtrl.post);
router.post('/api/editquestion', postCtrl.edit);
router.post('/api/featureclose', postCtrl.featureclose);
router.post('/api/delquestion', postCtrl.del);
router.post('/api/enordisablenotification', postCtrl.enableOrDisable);

router.post('/api/answer', postCtrl.answer);

router.post('/api/like', postCtrl.like);
router.post('/api/bookmark', postCtrl.bookmark);
